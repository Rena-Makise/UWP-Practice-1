...
namespace Set1_1_Hello_World
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            // BackRequest 이벤트에 대한 전역 수신기를 등록
            Windows.UI.Core.SystemNavigationManager.GetForCurrentView().BackRequested += App_BackRequest;
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // 구성합니다.
                    // 처음 앱을 구동할때 기본값으로 MainPage.xaml을 로드
        ...
        // BackRequest를 위한 메소드들
        private void App_BackRequest(object sender, Windows.UI.Core.BackRequestedEventArgs e)
        {
