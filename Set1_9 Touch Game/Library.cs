...
public class Library
{
    ...
    {
        Grid element = (Grid)grid.Children.Single(s => (int)((Grid)s).Tag == value);
    ...
    // 패턴을 섞는데 사용
    private List<int> Suffle(int start, int finish, int total)
    {
        int number;
        List<int> numbers = new List<int>();
        while ((numbers.Count < total)) // Select Number
        {
            // Random non-unique Number between Starrt and Finish
